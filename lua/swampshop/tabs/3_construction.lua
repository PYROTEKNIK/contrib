...
SS_Product({
    class = 'prop_launchpad',
    price = 10000,
    name = 'Launch Pad',
    description = "Launches player diagonally.",
    model = 'models/pyroteknik/booster.mdl',
    CannotBuy = CannotBuyTrash,
    OnBuy = function(self, ply)
...
SS_Product({
    ...
    price = 1000,
    name = 'Auto Turret',
    description = "Automatically shoots anything directly in front of it. Needs to be refilled with ammo. Can Carry up to 800 Rounds",
